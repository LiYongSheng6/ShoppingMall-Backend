...
public class AuthorizeAspect {
    ...
    public Object handle(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if(userId==null){
            throw new ServiceException(HttpStatus.UNAUTHORIZED, MessageConstants.NO_LOGIN_ERROR);
        }

        //判断是否为管理员
        boolean result = UserType.ADMIN.equals(Db.getById(userId, UserDO.class).getType());
